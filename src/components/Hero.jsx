...
import heroBg from "./../image/gangai_banner.jpg"; // background image
  ...
  <div className="container position-relative py-5" style={{ zIndex: 2 }}>
    <div className="row align-items-center">
      ...
      <div className="col-12 col-lg-8 text-center text-lg-start">
        ...
        <div className="d-flex justify-content-center justify-content-lg-start gap-5 mt-4 flex-wrap">
          {[{ img: erode, label: "Erode" }, { img: tirupur, label: "Tirupur" }, { img: cbe, label: "Coimbatore" }].map((loc, idx) => (
            <div key={idx} className="text-center">
              ...
              />
              <h5 className="mt-2">{loc.label}</h5>
            </div>
          ))}
        </div>
      </div>

      {/* RIGHT: Truck Image (Circular) */}
      <div className="col-12 col-lg-4 d-flex justify-content-center mt-4 mt-lg-0">
        <div className="rounded-circle overflow-hidden shadow position-relative banner-round">
          <img
            src={truckImage}
            alt="Borewell Truck"
